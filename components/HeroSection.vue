...
<template>
  <section id="home" class="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <!-- Floating shapes -->
      <div class="absolute top-20 left-10 w-72 h-72 bg-primary-200/30 rounded-full blur-3xl animate-float"></div>
      <div class="absolute bottom-20 right-10 w-96 h-96 bg-secondary-200/20 rounded-full blur-3xl animate-float" style="animation-delay: 2s"></div>
      ...
      <!-- Geometric patterns -->
      <div class="absolute top-32 right-20 w-4 h-4 bg-primary-400 rounded-full opacity-60"></div>
      <div class="absolute top-48 right-32 w-2 h-2 bg-secondary-400 rounded-full opacity-80"></div>
      <div class="absolute bottom-40 left-32 w-3 h-3 bg-primary-500 rounded-full opacity-50"></div>

      <!-- Grid pattern -->
      <div
        class="absolute inset-0 opacity-[0.03]"
        style="background-image: radial-gradient(circle, #0046d1 1px, transparent 1px); background-size: 40px 40px"
      ></div>
    </div>

    <div class="container mx-auto px-4 lg:px-8 pt-24 pb-12 relative z-10">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="text-center lg:text-left animate-fade-in">
          ...
          <h2 class="text-xl md:text-2xl lg:text-3xl font-semibold text-primary-500 mb-6">
            {{ t('hero.subtitle') }}
          </h2>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <el-button
              type="danger"
              size="large"
              class="!rounded-xl !px-8 !py-6 !text-base !font-semibold !bg-secondary-500 !border-secondary-500 hover:!bg-secondary-600 hover:!border-secondary-600 shadow-button hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
            ...
            <el-button
              size="large"
              class="!rounded-xl !px-8 !py-6 !text-base !font-semibold !border-2 !border-primary-300 !text-primary-600 hover:!bg-primary-50 transition-all duration-300"
        ...
        <div class="relative hidden lg:block animate-slide-up">
          <div class="relative">
              ...
              <div class="flex items-center justify-between mb-6">
                <div>
                  <p class="text-sm text-gray-500 mb-1">
                    {{ t('hero.card.financing') }}
                  </p>
                  <p class="text-2xl font-bold text-gray-900">300,000,000 UZS</p>
                </div>
              ...
              <div class="mt-6 pt-4 border-t border-gray-100">
                <div class="flex items-center space-x-3">
                  ...
                  <p class="text-sm text-gray-500">
                    {{ t('hero.card.successfulProjects') }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <!-- Floating cards -->
            <div class="absolute -top-4 -right-4 bg-white rounded-2xl shadow-lg p-4 transform -rotate-6 animate-float">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p class="text-sm font-semibold text-green-600">
                    {{ t('hero.card.approved') }}
                  </p>
                </div>
              </div>
            </div>

            <div class="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-lg p-4 transform rotate-3 animate-float" style="animation-delay: 1s">
              <div class="flex items-center space-x-3">
    ...
    <div class="absolute bottom-0 left-1/2 -translate-x-1/2 animate-bounce hidden md:block">
      <a href="#about" @click.prevent="scrollToProducts" class="flex flex-col items-center text-gray-400 hover:text-primary-500 transition-colors">
        <span class="text-xs mb-2">Pastga</span>
